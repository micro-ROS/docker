...
Forthcoming
-----------
* Add Github Action for libgen (`#80 <https://github.com/micro-ROS/docker/issues/80>`_) (`#81 <https://github.com/micro-ROS/docker/issues/81>`_)
* Add Base Docker generation action
* Add Agent Docker generation action
* Add download of esp32 crosscompiler (`#73 <https://github.com/micro-ROS/docker/issues/73>`_) (`#74 <https://github.com/micro-ROS/docker/issues/74>`_)
* support ROS_LOCALHOST_ONLY variable (backport `#69 <https://github.com/micro-ROS/docker/issues/69>`_) (`#70 <https://github.com/micro-ROS/docker/issues/70>`_)
* Fix wget certificate (`#66 <https://github.com/micro-ROS/docker/issues/66>`_) (`#67 <https://github.com/micro-ROS/docker/issues/67>`_)
* Update foxy docker
